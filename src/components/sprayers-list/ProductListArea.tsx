...
const categories = [
  "All",
  ...new Set(sprayers_data.map((item) => item.category)),
];
...
export default function ProductListArea() {
  ...
  const filterItems = (cateItem: string) => {
    ...
    if (cateItem === "All") {
      return setItems(sprayers_data);
    } else {
      const findItems = sprayers_data.filter((findItem) => {
