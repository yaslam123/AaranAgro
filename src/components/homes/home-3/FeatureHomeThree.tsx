              ...
              <div className="about-contentv1">
                <div className="section-title mb-40">
                  ...
                  <p
                    ...
                    data-wow-delay=".4s"
                  >
                    At Aaran Agritrade Ltd, we are committed to driving
                    agricultural progress through innovation, quality, and
                    sustainability. Our mission is to empower farmers, enhance
                    productivity, and secure a thriving future for agriculture
                    in Somalia.
                  </p>
                  <ul className="about-list2 mb-40 gap-2">
                    <li className="text-white">
                      <i className="fa-solid fa-check"></i> Grow with
                      Agriculture
                    </li>
                    <li className="text-white">
                      <i className="fa-solid fa-check"></i> Farming for a Better
                      Future
                    </li>
                    <li className="text-white">
                      <i className="fa-solid fa-check"></i> From Farm to Table,
                      Agriculture Matters
                    </li>
                  </ul>
                  <Link
