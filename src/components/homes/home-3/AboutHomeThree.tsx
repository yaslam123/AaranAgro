...
export default function AboutHomeThree() {
  ...
  return (
    <>
      <section className="about-section section-padding style-v01 white-bg">
                ...
                <div className="about-contentv1">
                  <div className="section-title mb-40">
                    ...
                    <p className="wow fadeInUp" data-wow-delay=".4s">
                      We elevate your farming to the next level, enabling you to
                      expand your cultivation targets and increase your income
                      from your farm, garden, and business. With our expert
                      guidance and innovative products, we help you grow more
